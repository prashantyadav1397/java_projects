 ...
 */
public class VCandidate_fnr extends javax.swing.JFrame {
 Connection con=null;
    ...
    private void initComponents() {
        ...
        background9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        background9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resource/polls.jpg"))); // NOI18N
        background9.setToolTipText("");
        background9.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        polres.add(background9);
        background9.setBounds(0, 0, 760, 570);

        res.add(polres, "card4");

        getContentPane().add(res);
        res.setBounds(230, 0, 760, 550);
